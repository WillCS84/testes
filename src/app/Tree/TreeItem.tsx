...
import { Instruction, ItemMode, type TreeItem as TreeItemType } from "./types"
import { token } from "@atlaskit/tokens"
import FocusRing from "@atlaskit/focus-ring"
import { TreeContext, DependencyContext } from "./context"
import { indentPerLevel } from "./constants"
import { delay, getParentLevelOfInstruction, Icon, Preview } from "./functions"
...
const TreeItem = memo(function TreeItem({
  ...
  return (
    <Fragment>
      <div css={[state === "idle" ? outerHoverStyles : undefined]} style={{ position: "relative" }}>
        <FocusRing isInset>
          <button
            {...aria}
        ...
        <DropdownMenu
          trigger={({ triggerRef, ...triggerProps }) => (
            <Button
              ...
              iconBefore={
                <MoreIcon label="Actions" size="small" primaryColor={token("color.icon.subtle", "#626F86")} />
              }
              {...triggerProps}
              spacing="compact"
